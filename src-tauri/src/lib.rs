...
pub fn run() {
    tauri::Builder::default()
        ...
        // The live recording, on its own thread because the capture backends
        // are not `Send` — see [`recording`].
        .manage(RecordingHost::default())
        .invoke_handler(tauri::generate_handler![
            commands::list_models,
            commands::download_model,
            commands::delete_model,
            commands::remote_model_size,
